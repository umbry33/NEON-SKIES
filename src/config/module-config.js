...
export const MODULE_CONFIG = {
  ...
  specials: [
    ...
    special({ id: "special-wingman", shareCode: 7, name: zh.wingman, type: "special", description: "\u6a2a\u5411\u4e24\u683c\u3002\u6700\u591a\u88c5\u5907\u4e00\u4e2a\uff0c\u81ea\u52a8\u53ec\u5524\u653b\u51fb\u50da\u673a\u3002", rarity: "epic", icon: "W", footprint: horizontal2, combat: true, maxCount: 1, behavior: { type: "wingman", fireInterval: 1 / 3, damage: 2 } }),
    ...
    special({ id: "special-zero", shareCode: 10, name: zh.zero, type: "special", description: "\u6a2a\u5411\u4e24\u683c\u3002\u51bb\u7ed3\u666e\u901a\u654c\u4eba\u548c\u654c\u65b9\u5f39\u5e55 3.5 \u79d2\u3002", rarity: "legendary", icon: "F", footprint: horizontal2, skill: { id: "freeze", name: "\u96f6\u5ea6\u9886\u57df", cooldown: 15, duration: 3.5 } }),
