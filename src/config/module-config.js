...
export const MODULE_CONFIG = {
  weapons: [
    ...
    weapon({ id: "weapon-nest", shareCode: 2, name: zh.nest, type: "weapon", description: "\u6a2a\u5411\u4e09\u683c\u3002\u6bcf 6 \u79d2\u5148\u5206\u6563\u53d1\u5c04 6 \u679a\u9ed1\u7ea2\u9707\u7206\u5bfc\u5f39\uff0c0.42 \u79d2\u540e\u5f00\u59cb\u7d22\u654c\uff0c\u547d\u4e2d\u540e\u9020\u6210\u5927\u8303\u56f4\u7206\u70b8\u3002", rarity: "epic", icon: "#", footprint: horizontal3, behavior: { type: "nest", fireInterval: 6, volley: 6, spreadAngle: 0.18, projectile: { damage: 5, speed: 580, homingDelay: 0.42, homingTurnRate: 8.5, radius: 18, life: 6, explosionRadius: 72, color: "#ef294d" } } }),
    weapon({ id: "weapon-ricochet", shareCode: 3, name: zh.ricochet, type: "weapon", description: "\u5360 1 \u683c\u3002\u5f39\u4f53\u78b0\u5230\u8fb9\u7f18\u6216\u654c\u4eba\u540e\u53cd\u5f39\u3002", rarity: "rare", icon: "~", behavior: { type: "ricochet", fireInterval: 0.58, projectile: { damage: 2, speed: 360, radius: 5, life: 6, color: "#ffd36e" } } }),
    weapon({ id: "weapon-ball-lightning", shareCode: 4, name: zh.ball, type: "weapon", description: "\u5360 1 \u683c\u3002\u6bcf 4 \u79d2\u53d1\u5c04\u4e00\u9897\u4f1a\u5feb\u901f\u81a8\u80c0\u7684\u7403\u72b6\u95ea\u7535\uff0c\u98de\u884c\u8d8a\u4e45\u4f24\u5bb3\u8d8a\u9ad8\uff0c\u4ece 3 \u70b9\u589e\u81f3 9 \u70b9\u3002", rarity: "epic", icon: "o", behavior: { type: "ballLightning", fireInterval: 4, projectile: { damage: 3, damageEnd: 9, speed: 188.5, growthRate: 8.8, radius: 12, life: 4.5, color: "#b7a1ff" } } }),
    weapon({ id: "weapon-psionic", shareCode: 5, name: zh.psionic, type: "weapon", description: "\u5360 1 \u683c\u3002\u53d1\u5c04\u7075\u80fd\u7c92\u5b50\uff0c\u547d\u4e2d\u540e\u5728 30px \u8303\u56f4\u5185\u7206\u70b8\uff1b\u540c\u7c7b\u6a21\u5757\u8d8a\u591a\u653b\u901f\u8d8a\u5feb\u3002", rarity: "rare", icon: "@", behavior: { type: "psionic", stackKey: "psionic", stackedIntervals: [1.5, 1.3, 1], projectile: { damage: 6, speed: 310, radius: 10, life: 3, explosionRadius: 30, color: "#72f1c0" } } }),
    ...
    weapon({ id: "weapon-black-hole", shareCode: 15, name: zh.blackHole, type: "weapon", description: "\u5360 2 \u00d7 2 \u683c\u3002\u6bcf 7 \u79d2\u53d1\u5c04\u4e00\u679a\u7f13\u6162\u79fb\u52a8\u7684\u9ed1\u6d1e\uff0c\u5438\u5f15\u654c\u673a\u548c\u654c\u65b9\u5f39\u5e55\uff1b\u9996\u6b21\u5438\u5230\u654c\u673a\u540e 1 \u79d2\u7206\u70b8\uff0c\u5438\u5f15\u8303\u56f4\u5728\u5012\u8ba1\u65f6\u5185\u6269\u5927 75\uff05\u3002", rarity: "legendary", icon: "B", footprint: square2, behavior: { type: "blackHole", fireInterval: 7, projectile: { damage: 2, speed: 66, radius: 16, life: 5.5, color: "#b57bff", blackHole: { pullRadius: 132, pullStrength: 105, damageInterval: 0.25, explosionRadius: 74, explosionDamage: 10 } } } }),
    ...
    weapon({ id: "weapon-fire-feather", shareCode: 33, name: "火羽", type: "weapon", footprint: horizontal2, description: "横向两格，竖向一格。自动寻找敌人最密集的方向齐射九片火焰羽片；同一敌人被火羽命中两次后触发烈羽冲击并被击退。", rarity: "legendary", icon: "FF", element: "fire", behavior: { type: "fireFeather", fireInterval: 1.4, volley: 9, spreadAngle: 0.1, projectile: { damage: 3, speed: 390, radius: 6, life: 3.6, color: "#ff3b32", featherMarkDuration: 3, featherBurstDamage: 4 } } }),
    weapon({ id: "weapon-water-moon", shareCode: 34, name: "水月", type: "weapon", footprint: square2, description: "占 2 × 2 格。持续制造环绕模块旋转的水色月牙刃，在近身范围内切割敌人；每三枚月刃生成一枚更大的满月刃。", rarity: "legendary", icon: "WM", element: "water", behavior: { type: "waterMoon", fireInterval: 0.65, projectile: { damage: 5, speed: 285, radius: 10, life: 4.4, color: "#8de8ff", orbitRadius: 62, orbitSpeed: 2.4, orbitVerticalScale: 0.82, hitLimit: 2 } } }),
  ],
  specials: [
...
const PLAYER_DISABLED_BACKUP_MODULES = [...MODULE_CONFIG.weapons, ...MODULE_CONFIG.specials].filter((module) => PLAYER_DISABLED_MODULE_IDS.has(module.id) && !FUSION_MODULES.includes(module));
...
if (blackHoleModule) {
  blackHoleModule.description = "\u5360 2 \u00d7 2 \u683c\u3002\u6bcf 7 \u79d2\u53d1\u5c04\u4e00\u679a\u7f13\u6162\u79fb\u52a8\u7684\u9ed1\u6d1e\uff0c\u5438\u5f15\u654c\u673a\u548c\u654c\u65b9\u5f39\u5e55\uff1b\u9996\u6b21\u5438\u5230\u654c\u673a\u540e 1 \u79d2\u7206\u70b8\uff0c\u5438\u5f15\u8303\u56f4\u5728\u5012\u8ba1\u65f6\u5185\u6269\u5927 75\uff05\u3002";
...
export const ALL_MODULES = [CORE_MODULE, ...MODULE_CONFIG.weapons, ...MODULE_CONFIG.specials, ...PLAYER_DISABLED_BACKUP_MODULES, ...FUSION_MODULES.filter((module) => PLAYER_DISABLED_MODULE_IDS.has(module.id))];
